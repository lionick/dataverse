...
@ViewScoped
@Named("PivotPage")
public class PivotPage implements java.io.Serializable {
    ...
    private static final Logger logger = Logger.getLogger(PivotPage.class.getCanonicalName());
    ...
    public String init() {
        ...
        if (fileId != null || persistentId != null) {
            ...
            try {
                ...
                this.setRowVariables(fileMetadata.getRowVariables());
                this.setColVariables(fileMetadata.getColumnVariables());
                this.setValVariables(fileMetadata.getValueVariables());
