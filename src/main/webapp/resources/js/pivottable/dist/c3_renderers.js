    ...
    makeC3Chart = function(chartOpts) {
      ...
      return function(pivotData, opts) {
        ...
        if ((base2 = opts.c3.size).height == null) {
		  ...
		  if(pivotData.rowKeys.length>0 && chartOpts.type=="bar" && chartOpts.horizontal==true)
		  opts.c3.size.height =(pivotData.rowKeys.length*30 > opts.c3.size.height ? pivotData.rowKeys.length*30: opts.c3.size.height);
